...
<div class="w3-bar">
    ...
    <div class="w3-bar-item">
        <a class="menu w3-bar-item w3-button w3-hide-small" id="PerfilController" href="#">Profile</a>
...
<div id="stack" class="w3-bar-block w3-hide w3-hide-large w3-hide-medium">
    <a class="menu w3-bar-item w3-button" id="PerfilController" href="#">Profile</a>
